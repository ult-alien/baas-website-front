  ...
  <div class="page-nav-wrapper">
    <div class="page-nav-title">
      <el-breadcrumb separator="/" >
        ...
        <el-breadcrumb-item v-if="!navTitle">{{curNavName}}</el-breadcrumb-item>
        <el-breadcrumb-item v-else>{{navTitle}}</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
      ...
      previousNav () {
        ...
        if (this.showPrevious) {
          if (this.previousPath && routerMap[this.previousPath]) {
            let state = sysUtil.getState(this.previousPath);
