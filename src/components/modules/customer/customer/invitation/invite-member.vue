  ...
  <pl-content-box>
    ...
    <pl-content-box-block>
      <pl-page-table
       ...
       <!-- <el-table-column  prop="inviterName" label="核心企业"   :show-overflow-tooltip="true"></el-table-column>-->
        <el-table-column  prop="inviteeName" label="成员单位"  :show-overflow-tooltip="true"></el-table-column>
    ...
    <data-import ref="dataImportDialog"   @refresh="query" downloadType="2"></data-import>
  ...
  export default {
    data () {
      return {
        ...
        params: {
          inviterId: this.$store.state.contextData.user.ent.organId,
          inviteeName: '',
          registered: ''
        },
        loading: false,
