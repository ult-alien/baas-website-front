<template>
  <div>
    ...
    <pl-content-box-toolbar>
      <div class="pull-left" >
        <el-input style="width: 200px;" v-model="params.searchValue" placeholder="请输入机构名称/机构编码">
        </el-input>
    ...
    <pl-content-box-block>
      <pl-page-table :data-fun="getPageData" :params="params" ref="pageTable"  default-sort-prop="cus_name" default-sort-order="descending">
        <!--<el-table-column header-align="center" align="center" prop="socCrCode" label="统一社会信用代码" width="160"></el-table-column>-->
        <el-table-column  prop="cusName" label="机构名称"></el-table-column>
        <el-table-column  prop="cusCode" label="机构编码" width="100"></el-table-column>
        ...
        <el-table-column  prop="cusState" label="状态" width="120">
        ...
        <el-table-column header-align="center" align="center" label="操作" width="150" fixed="right">
          <template slot-scope="scope">
            <el-button-group>
              ...
              <el-button size="mini" @click="handleEdit(scope.row.cusId)">修改</el-button>
            </el-button-group>
          </template>
        </el-table-column>
      </pl-page-table>
...
<script>
  ...
  export default {
    data () {
      return {
        params: {
          cusName: '',
          cusCode: '',
          cusType: cusType['FOCAL_CO'],
          loginName: '',
          searchValue: ''
        },
        getPageData: this.$api.cust.customer.findCus,
        msg: ''
      };
    },
    components: {
    ...
    methods: {
      ...
      handleEdit (cusId) {
        this.$router.push({name: 'bsp.biz.customer-edit', params: {cusId, cusType: this.params.cusType}});
      },
      handleAdd () {
        this.$router.push({name: 'bsp.biz.customer-edit', params: {cusType: this.params.cusType}});
      }
    }
  };
</script>
