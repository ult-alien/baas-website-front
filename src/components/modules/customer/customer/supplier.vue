<template>
   <div>
    <pl-content-box-toolbar>
      <div class="pull-left" >
        <el-input style="width: 200px;" v-model="params.searchValue" placeholder="请输入供应商名称/供应商编码">
        </el-input>
    ...
    <pl-content-box-block>
      <pl-page-table :data-fun="getPageData" ref="pageTable" default-sort-prop="cus_name" default-sort-order="descending">
        ...
        <el-table-column  prop="cusName" width="200" label="供应商名称"></el-table-column>
        <el-table-column  prop="cusCode" label="供应商编码" width="120"></el-table-column>
        ...
        <!--<el-table-column  prop="entName" label="对应客户" width="200"></el-table-column>-->
...
export default {
  data () {
    return {
      ...
      getPageData: this.$api.cust.customer.findSupplierForFin,
      msg: ''
    };
  },
  components: {
  ...
  methods: {
    ...
    handleEdit (cusId) {
      this.$router.push({name: 'bsp.biz.customer-edit', params: {cusId, cusType: cusType['SUPPLIER']}});
    },
    handleAdd () {
      this.$router.push({name: 'bsp.biz.customer-edit', params: {cusType: cusType['SUPPLIER']}});
    }
  }
};
</script>
