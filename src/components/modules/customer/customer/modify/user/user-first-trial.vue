<template>
  <pl-content-box>
    <pl-content-box-toolbar>
      <div class="pull-left" >
        <pl-constant-select type="PubConstants.UserState"  invalidKeys="E,U,D,I" v-model="params.userState" :showEmpty="true" style="width: 120px;"></pl-constant-select>
    ...
    <pl-content-box-block>
      <pl-page-table :data-fun="getData" :params="params" ref="pageTable" style="width:100%" default-sort-prop="opr_time" default-sort-order="descending">
        ...
        <el-table-column   label="操作" width="80" align="center" header-align="center">
          <template slot-scope="scope">
            <el-button-group>
                <el-button size="mini" v-if="scope.row.userState === UserState['DCS'] || scope.row.userState === UserState['ZSBH']" type="primary"  @click="handleApr(scope.row)">
                  审批
                </el-button>
...
<script>
  ...
  export default {
    data () {
      return {
        getData: this.$api.bsp.user.selectUserForFirstTrial,
        params: {
          userState: '',
          queryValue: ''
        },
    ...
    methods: {
      ...
      handleApr (row) {
        ...
        this.$router.push({'name': 'bsp.biz.user-first-trial-detail', params});
      }
    }
  };
</script>
