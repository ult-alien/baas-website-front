...
let radMin = 5;
let radMax = 40;
let filledCircle = 60; // percentage of filled circles
let concentricCircle = 30; // percentage of concentric circles
let radThreshold = 25; // IFF special, over this radius concentric, otherwise filled
...
let colors = ['154,218,218'];
let bgColors = ['92,189,170', '117,95,147', '199,108,23', '194,62,55', '0,172,212', '120,120,120'];
let circleBorder = 10;
...
// experimental lets
let circleExp = 1;
let circleExpMax = 1.003;
let circleExpMin = 0.997;
let circleExpSp = 0.00004;
let circlePulse = false;
...
function Circle (background) {
  ...
  let spacey = Math.abs((this.y - (this.speedy < 0 ? -1 : 1) * (canvas.height / 2 + this.radius)) / this.speedy);
...
export default function init (canvasEle, canvasBgEle) {
  canvas = canvasEle;
  canvasbg = canvasBgEle;
