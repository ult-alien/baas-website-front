  ...
  <el-form ref="userForm" :model="accreditationForm" label-position="right" label-width="140px">
   ...
   <!-- <pl-content-box-title>
    ...
    <p class="info text-center" style="padding: 10px;margin-top: 10px;">
      <i class="el-icon-warning"></i>&ensp;企业操作员享有办理链单业务的权利，平台将按您申请的操作员数量为您邮寄安全证书，最多可免费申请两个安全证书。
    </p>
    <pl-content-box-block :fixed-width="false">
      <pl-content-box-card-group>
      <pl-content-box-card class="accreditation-content-box" v-for="(operator, index) in accreditationForm.operators">
        <div class="accreditation-content">
          <el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addOperator () {
        this.accreditationForm.operators.push({'userName': '', 'phoneNo': '', 'certType': '', 'certNo': '', 'email': '', 'loginName': '', 'operateType': 'newOperator'});
      },
      delOperator (index) {
