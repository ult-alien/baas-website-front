            ...
            <el-row>
              ...
              <el-col :span="10">
                <el-form-item label="账号" :key="'acctNo_'+ index" :prop="'accountInfo.' + index + '.acctNo'" :rules="[
                  ...
                  <el-input v-model="item.acctNo" placeholder="请输入账号"></el-input>
                </el-form-item>
              </el-col>
              ...
              <pl-dictionary-select :show-empty="false" type="bank_brand" clearable v-model="item.fiNo"></pl-dictionary-select>
              ...
              <el-col :span="10">
                <el-form-item label="账户名称" :key="'acctNm_'+ index" :prop="'accountInfo.' + index + '.acctNm'" :rules="[
                  ...
                  <el-input v-model="item.acctNm" placeholder="请输入账户名称"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="10">
      ...
      save () {
        ...
        this.$refs['form'].validate((valid) => {
          if (valid) {
            ...
            delete obj.phoneExt;
            this.loading = true;
            this.$api.bsp.customer.saveCustomer(obj).then(ret => {
